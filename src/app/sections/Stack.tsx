...
export function Stack() {
	...
	return (
		<div className="container -mt-16 mb-10 px-3">
			<div
				className="rounded-xl shadow-card bg-white flex flex-col mx-auto max-w-xl lg:max-w-none lg:flex-row text-center divide-stroke divide-y lg:divide-y-0 lg:divide-x">
