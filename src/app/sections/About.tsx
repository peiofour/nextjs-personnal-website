...
const text = ['Je m’appelle Pierre. Je suis un développeur basé à Toulouse avec plus de 6 ans d\'expérience dans la création d\'applications web et mobiles sur mesure. Je suis diplômé de l’école YNOV Campus en développement logiciel et mobile.',
