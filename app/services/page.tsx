...
import { FaCloud, FaCode, FaServer } from "react-icons/fa6"
...
export default function Page() {
  return (
    <div className='container pb-10 pt-5'>
      <h1 className='pb-3 text-3xl font-bold'>Mes services</h1>
      <h2 className='max-w-xl pb-10 text-lg text-gray-500'>
        Découvrez mes services de développement web et mobile.
      </h2>
